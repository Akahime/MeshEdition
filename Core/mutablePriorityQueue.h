//
// Created by Sarah Gross on 5/22/18
//
#include <set>
using namespace std;
...
#ifndef MESHEDITION_MUTABLEPRIORITYQUEUE_H
#define MESHEDITION_MUTABLEPRIORITYQUEUE_H
...
#endif //MESHEDITION_MUTABLEPRIORITYQUEUE_H
